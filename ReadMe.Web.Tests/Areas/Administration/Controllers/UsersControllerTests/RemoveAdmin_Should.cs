...
{
    [TestFixture]
    public class RemoveAdmin_Should
    {
        [Test]
        public void CallProviderRemoveFromRole_WhenInvoked()
        {
            ...
            controller.RemoveAdmin(id, page);

            providerMock.Verify(v => v.RemoveFromRole(id, "Admin"), Times.Once);
        }
        ...
        public void RedirectToControllerIndexAction_WhenInvoked()
        {
            ...
            controller.WithCallTo(c => c.RemoveAdmin(id, page))
